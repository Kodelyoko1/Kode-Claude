#!/usr/bin/env python3
"""BentoForge autonomous loop — render link-in-bio pages, deliver, pitch leads."""
...
def cycle():
    console.print(Panel(
        ...
        title="[bold blue]Wholesale Omniverse — BentoForge[/bold blue]",
        border_style="blue"))
    r = run_full_cycle()
...
def main():
    ...
    if not paywall_prompt("bentoforge"):
        return
    while True:
        cycle()
        if args.interval <= 0:
