"""NotionTemplate subscribers. Per-template ($19) · Monthly 3-template ($49/mo) · Monthly unlimited ($149/mo)."""
...
SUBS = DATA_DIR / "nt_subscribers.json"
LOG  = DATA_DIR / "nt_subscription_log.json"

PLANS = {
    "per_template_19": {
        "price_mo": 0,
        "one_time": 19,
        "label": "Per-template ($19)"
    },
    "monthly_49": {
        "price_mo": 49,
        "one_time": 0,
        "label": "Monthly 3-template ($49/mo)"
    },
    "monthly_unlimited_149": {
        "price_mo": 149,
        "one_time": 0,
        "label": "Monthly unlimited ($149/mo)"
    }
}
...
def activate(email):
    ...
    if not isinstance(subs, list): return {"error": "nt_subscribers.json wrong shape"}
    for s in subs:
