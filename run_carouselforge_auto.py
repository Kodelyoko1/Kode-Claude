#!/usr/bin/env python3
"""CarouselForge autonomous loop — render carousels, deliver to subs, pitch leads."""
...
def cycle():
    console.print(Panel(
        ...
        title="[bold blue]Wholesale Omniverse — CarouselForge[/bold blue]",
        border_style="blue"))
    r = run_full_cycle()
...
def main():
    ...
    if not paywall_prompt("carouselforge"):
        return
    while True:
        cycle()
        if args.interval <= 0:
