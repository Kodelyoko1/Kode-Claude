"""GutenbergVoice subscribers. Chapter pack ($19) · Full kit ($97) · Premium kit ($297) · Script of the Week ($29/mo)."""
...
SUBS = DATA_DIR / "gv_subscribers.json"
LOG  = DATA_DIR / "gv_subscription_log.json"

PLANS = {
    "chapter_19": {
        "price_mo": 0,
        "one_time": 19,
        "label": "Chapter pack ($19)"
    },
    "full_kit_97": {
        "price_mo": 0,
        "one_time": 97,
    ...
    "premium_297": {
        "price_mo": 0,
        "one_time": 297,
        "label": "Premium kit ($297)"
    },
    "weekly_29": {
        "price_mo": 29,
        "one_time": 0,
        "label": "Script of the Week ($29/mo)"
    }
}
...
def activate(email):
    ...
    if not isinstance(subs, list): return {"error": "gv_subscribers.json wrong shape"}
    for s in subs:
