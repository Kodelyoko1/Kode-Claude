"""TemplateForge health: per-template outcomes + delivery log."""
...
INPUTS_DIR  = DATA_DIR / "td_inputs"
OUTPUTS_DIR = DATA_DIR / "td_outputs"
FILE_LOG    = DATA_DIR / "td_template_log.json"
DELIVERY    = DATA_DIR / "td_delivery_outcomes.json"
LOG_MAX     = int(os.environ.get("TD_LOG_MAX", "300"))
VALID = {'success', 'build_failed', 'spec_invalid', 'no_design'}
...
def probe_inputs():
    ...
    return {"ok": n_in > 0, "td_inputs": n_in, "td_outputs": n_out,
