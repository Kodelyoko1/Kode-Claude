"""ProofBot subscribers. Per-page ($15) · Monthly 10-page ($39/mo) · Unlimited ($129/mo)."""
...
SUBS = DATA_DIR / "pf_subscribers.json"
LOG  = DATA_DIR / "pf_subscription_log.json"
...
PLANS = {
    ...
    "monthly_39": {
        "price_mo": 39,
        "one_time": 0,
        "label": "Monthly 10-page ($39/mo)"
    },
    "monthly_unlimited_129": {
        "price_mo": 129,
        "one_time": 0,
        "label": "Unlimited ($129/mo)"
    }
}
...
def activate(email):
    ...
    if not isinstance(subs, list): return {"error": "pf_subscribers.json wrong shape"}
    for s in subs:
