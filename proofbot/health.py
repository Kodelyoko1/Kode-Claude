"""ProofBot health: per-page outcomes + delivery log."""
...
INPUTS_DIR  = DATA_DIR / "pf_inputs"
OUTPUTS_DIR = DATA_DIR / "pf_outputs"
FILE_LOG    = DATA_DIR / "pf_page_log.json"
DELIVERY    = DATA_DIR / "pf_delivery_outcomes.json"
LOG_MAX     = int(os.environ.get("PF_LOG_MAX", "300"))
VALID = {'success', 'lt_unreachable', 'build_failed', 'no_content'}
...
def record_page(slug, outcome, detail="", **extra):
    if not slug: return
...
def probe_inputs():
    ...
    return {"ok": n_in > 0, "pf_inputs": n_in, "pf_outputs": n_out,
