"""DeckForge subscribers. Per-deck ($49) · Monthly 5-deck ($149/mo) · Founder package ($497)."""
...
SUBS = DATA_DIR / "dk_subscribers.json"
LOG  = DATA_DIR / "dk_subscription_log.json"
...
PLANS = {
    ...
    "monthly_149": {
        "price_mo": 149,
        "one_time": 0,
        "label": "Monthly 5-deck ($149/mo)"
    },
    "founder_497": {
        "price_mo": 0,
        "one_time": 497,
        "label": "Founder package ($497)"
    }
}
...
def activate(email):
    ...
    if not isinstance(subs, list): return {"error": "dk_subscribers.json wrong shape"}
    for s in subs:
