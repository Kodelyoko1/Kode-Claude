"""DomainScout subscribers. Per-list ($29) · Weekly lists ($79/mo) · Done-for-you ($297)."""
...
SUBS = DATA_DIR / "dm_subscribers.json"
LOG  = DATA_DIR / "dm_subscription_log.json"
...
PLANS = {
    ...
    "weekly_79": {
        "price_mo": 79,
        "one_time": 0,
        "label": "Weekly lists ($79/mo)"
    },
    "done_for_you_297": {
        "price_mo": 0,
        "one_time": 297,
        "label": "Done-for-you ($297)"
    }
}
...
def activate(email):
    ...
    if not isinstance(subs, list): return {"error": "dm_subscribers.json wrong shape"}
    for s in subs:
