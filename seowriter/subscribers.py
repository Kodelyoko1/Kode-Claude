"""SEOWriter subscribers. Per-article ($39) · Monthly 5-article ($149/mo) · Unlimited ($499/mo)."""
...
SUBS = DATA_DIR / "sw_subscribers.json"
LOG  = DATA_DIR / "sw_subscription_log.json"

PLANS = {
    "per_article_39": {
        "price_mo": 0,
        "one_time": 39,
        "label": "Per-article ($39)"
    },
    "monthly_149": {
        "price_mo": 149,
        "one_time": 0,
        "label": "Monthly 5-article ($149/mo)"
    },
    "monthly_unlimited_499": {
        "price_mo": 499,
        "one_time": 0,
...
def activate(email):
    ...
    if not isinstance(subs, list): return {"error": "sw_subscribers.json wrong shape"}
    for s in subs:
