...
_STATUS_LABEL = {
    ...
    "duplicate_skipped": "⏭️ SKIPPED — already have exposure on this symbol",
    "exposure_unknown": "🛑 BLOCKED — could not verify existing exposure (fails closed)",
    "stops_too_close": "⚠️ BLOCKED — SL/TP inside the broker's minimum stop distance",
