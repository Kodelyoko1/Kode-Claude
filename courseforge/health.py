"""CourseForge health: per-course outcomes + delivery log."""
...
INPUTS_DIR  = DATA_DIR / "co_inputs"
OUTPUTS_DIR = DATA_DIR / "co_outputs"
FILE_LOG    = DATA_DIR / "co_course_log.json"
DELIVERY    = DATA_DIR / "co_delivery_outcomes.json"
LOG_MAX     = int(os.environ.get("CO_LOG_MAX", "300"))
VALID = {'success', 'build_failed', 'no_modules', 'spec_invalid'}
...
def record_course(slug, outcome, detail="", **extra):
    if not slug: return
...
def probe_inputs():
    ...
    return {"ok": n_in > 0, "co_inputs": n_in, "co_outputs": n_out,
