"""Localize subscribers. Per-page ($19) · Monthly 5-page ($49/mo) · Monthly unlimited ($199/mo)."""
...
SUBS = DATA_DIR / "lz_subscribers.json"
LOG  = DATA_DIR / "lz_subscription_log.json"
...
PLANS = {
    ...
    "monthly_49": {
        "price_mo": 49,
        "one_time": 0,
        "label": "Monthly 5-page ($49/mo)"
    },
    "monthly_unlimited_199": {
        "price_mo": 199,
        "one_time": 0,
        "label": "Monthly unlimited ($199/mo)"
    }
}
...
def activate(email):
    ...
    if not isinstance(subs, list): return {"error": "lz_subscribers.json wrong shape"}
    for s in subs:
